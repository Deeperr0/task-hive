			...
			<div className="bg-accent-50 p-8 rounded-lg shadow-lg lg:w-1/2 shrink-0 text-primary-900">
				...
				<form className="space-y-6" onSubmit={handleSubmit}>
					<div className="flex flex-col space-y-2">
						<label htmlFor="firstName" className="text-accent-50">
							First Name
						</label>
						<input
							id="firstName"
					...
					<div className="flex flex-col space-y-2">
						<label htmlFor="lastName" className="text-accent-50">
							Last Name
						</label>
						<input
							id="lastName"
					...
					<div className="flex flex-col space-y-2">
						<label htmlFor="email" className="text-accent-50">
							Email
						</label>
						<input
							id="email"
					...
					<div className="flex flex-col space-y-2">
						<label htmlFor="phone" className="text-accent-50">
							Phone Number
						</label>
						<input
							id="phone"
					...
					<div className="flex flex-col space-y-2">
						<label htmlFor="message" className="text-accent-50">
							How can we help?
						</label>
						<textarea
							id="message"
